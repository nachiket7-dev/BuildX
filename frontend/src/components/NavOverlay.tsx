    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 z-50 bg-obsidian-bg/95 backdrop-blur-3xl flex flex-col justify-between p-6 sm:p-12 overflow-hidden font-sans"
        >
          {/* ── Ambient Background Mesh Lighting ── */}
          <div className="absolute top-0 left-0 w-[600px] h-[350px] bg-sylven/10 blur-[140px] pointer-events-none rounded-full" />
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[550px] h-[550px] bg-emerald-500/10 blur-[160px] pointer-events-none rounded-full" />
          ...
          {/* ── Header Bar ── */}
          <div className="flex items-center justify-between border-b border-obsidian-border pb-6 relative z-10">
            <div className="flex items-center gap-2 text-xs font-mono text-norvin-muted">
              <span className="w-2 h-2 rounded-full bg-sylven animate-pulse" />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.92 }}
              onClick={onClose}
              className="p-3 rounded-full bg-obsidian-panel backdrop-blur-md border border-obsidian-border hover:bg-obsidian-surface text-white transition-all shadow-lg"
                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className="group w-full flex items-center justify-between text-left px-4 py-4 rounded-2xl border-b border-obsidian-borderSubtle hover:border-sylven/40 hover:bg-obsidian-panel/40 transition-all duration-300 transform hover:translate-x-2"
                    >
                      <div className="flex items-baseline gap-4 sm:gap-8">
                        <span className="font-mono text-sm sm:text-lg text-sylven-light font-bold tracking-wider">
                          {item.num}
                        </span>
                        <span className="font-display text-3xl sm:text-6xl font-extrabold text-white group-hover:text-sylven-light transition-colors duration-300">
                          {item.label}
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-norvin-muted group-hover:text-sylven-light transition-colors">
          ...
          {/* ── Footer Info ── */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-obsidian-border pt-6 font-mono text-xs text-zinc-500 relative z-10">
