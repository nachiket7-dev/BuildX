...
export function BlueprintsPage() {
  return (
    <div className="min-h-screen bg-[#08080c] text-white relative overflow-x-hidden">
      ...
      <div className="absolute top-20 right-10 w-[500px] h-[300px] bg-indigo-600/20 blur-[160px] pointer-events-none rounded-full" />
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-10 pb-6 border-b border-white/10">
          <div>
            <div className="flex items-center gap-2 mb-2 font-mono text-xs text-zinc-400">
              <span className="text-indigo-400 font-semibold">02 / BLUEPRINT LIBRARY</span>
              <span>•</span>
