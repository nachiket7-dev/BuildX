...
export function NewBlueprintPage() {
  return (
    <div className="min-h-screen bg-obsidian-bg text-white relative overflow-x-hidden">
      <PageHead
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[350px] bg-sylven/10 blur-[150px] pointer-events-none rounded-full" />
