...
/**
 * React Bits Aurora — WebGL shader with flowing noise bands.
...
export function Aurora({
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const { speed: s, amplitude: amp, blend: bl, colorStops: stops } = propsRef.current;
      if (!program) return;
  ...
  return <div ref={containerRef} className="aurora-container" aria-hidden />;
}
